...
*Задание 2* Напишите функцию вывода обобщённого списка на экран используя макросы: функция =list_##type##_print= внутри макроса =DEFINE_LIST=. Протестируйте её на любых трёх списках разной длины.

*Задание 3* Напишите функцию вывода обобщённого списка на экран используя generic:  макрос =list_print=, который использует =_Generic=. Протестируйте её на любых трёх списках разной длины.

...
#+TITLE: Семинар 5: Синтаксис языка C, препроцессор языка C
...
*Задание 2* Напишите функцию вывода обобщённого списка на экран двумя используя макросы: Функция =list_##type##_print= внутри макроса =DEFINE_LIST= и протестируйте её на любых трёх списках разной длины.

*Задание 3* Напишите функцию вывода обобщённого списка на экран двумя используя макросы   - Одна функция =list_print=, которая использует =_Generic= и протестируйте её на любых трёх списках разной длины.
